...
const Feed = () => {
  return (
    <div className="flex gap-8 max-w-7xl mx-auto py-8 px-4 lg:px-8">
      {/* Main Feed Column */}
        ...
        <div className="card p-6 mb-8 backdrop-blur-sm bg-white/90 border-slate-200/80">
           <div className="flex gap-4">
              ...
              <div className="flex-1">
                 <button className="w-full text-left bg-slate-50 hover:bg-white hover:shadow-md hover:border-slate-300 text-slate-500 py-4 px-6 rounded-2xl border border-slate-200 transition-all duration-300 text-sm font-medium flex items-center justify-between group">
                    <span>Draft a clinical case or update...</span>
                    <span className="bg-slate-200 text-slate-600 px-2 py-1 rounded-md text-xs font-bold opacity-0 group-hover:opacity-100 transition-opacity">CMD + K</span>
                 </button>
...
const MedicalCaseCard = ({ author, role, org, time, title, content, image, tags, stats, verified, category }) => (
    ...
    >
        ...
        <div className="p-5 flex items-start justify-between">
            <div className="flex gap-4">
                <img src="https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?auto=format&fit=crop&q=80&w=2070" className="w-12 h-12 rounded-full object-cover ring-2 ring-slate-100" />
                <div>
        ...
        <div className="px-5 pb-3">
            <div className="mb-3">
                ...
                <h3 className="text-lg font-bold text-slate-900 leading-snug mb-2 group-hover:text-sky-600 transition-colors cursor-pointer">
                    {title}
                </h3>
        ...
        {image && (
            <div className="px-5 pb-5">
                <div className="relative h-64 w-full rounded-xl overflow-hidden shadow-sm group-hover:shadow-md transition-shadow">
